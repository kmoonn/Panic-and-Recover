...
- [大模型QKV](1-基础/大模型QKV.md)
- [大模型评测指标](1-基础/大模型评测指标.md)
- [LLM常见问题](1-基础/LLM常见问题.md)
...
- [三层架构](4-MCP/三层架构.md)
- [核心概念](4-MCP/核心概念.md)
- [通信生命周期](4-MCP/通信生命周期.md)
- [传输方式](4-MCP/传输方式.md)
- [StreamableHTTP](4-MCP/StreamableHTTP.md)
- [Sampling](4-MCP/Sampling.md)
- [MCP与FunctionCalling的区别](4-MCP/MCP与FunctionCalling的区别.md)
- [MCP与Skill的区别](4-MCP/MCP与Skill的区别.md)

## Skill

- [Skill结构](5-Skill/Skill结构.md)
- [渐进式披露机制](5-Skill/渐进式披露机制.md)

## 其他

- [AI提效](7-其他/AI提效.md)
- [ClaudeCode模式](7-其他/ClaudeCode模式.md)
- [对未来AI使用的看法](7-其他/对未来AI使用的看法.md)
- [AI用例生成评估](7-其他/AI用例生成评估.md)
