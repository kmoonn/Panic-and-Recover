...
### MySQL
[1. MySQL中存储时间日期到底选择哪种类型](3-mysql/1.%20MySQL中存储时间日期到底选择哪种类型.md)

[2. int(1) 和 int(10) 区别是什么 ? int 类型到底需不需要设置长度](3-mysql/2.%20int%20(1)%20%20和%20int%20(10)%20区别是什么？int%20类型到底需不需要设置长度.md)
